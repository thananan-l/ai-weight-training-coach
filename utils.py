...
def get_landmark_features(kp_results, dict_features, feature, frame_width, frame_height):
    ...
    if feature == 'nose':
        ...
        ear_coord = get_landmark_array(
            kp_results, dict_features[feature]['ear'], frame_width, frame_height)
        ...
        return ear_coord, shldr_coord, elbow_coord, wrist_coord, hip_coord, knee_coord, ankle_coord, foot_coord
